...
# アプリログレベル
LOG_LEVEL_CONTROLLER = os.getenv("LOG_LEVEL_CONTROLLER", "INFO")
LOG_LEVEL_MODEL_WORKER = os.getenv("LOG_LEVEL_MODEL_WORKER", "INFO")
LOG_LEVEL_OPEN_API_SERVER = os.getenv("LOG_LEVEL_OPEN_API_SERVER", "INFO")
LOG_LEVEL_MODEL_ADAPTER = os.getenv("LOG_LEVEL_MODEL_ADAPTER", "INFO")
# アプリログ以外のログ出力有効化フラグ
ENABLE_INOUT_LOG = bool(strtobool(os.getenv("ENABLE_INOUT_LOG", "True")))
# OpenAPIログメッセージ: 400応答
LOG_MESSAGE_BAD_REQUEST = "Bad Request"
# OpenAPIログメッセージ: 401応答
LOG_MESSAGE_UNAUTHORIZED = "Unauthorized"
# OpenAPIログメッセージ: 500応答
LOG_MESSAGE_INTERNAL_SERVER_ERROR = "Internal Server Error"
# OpenAPIログメッセージ: その他応答
LOG_MESSAGE_OTHER_ERROR = "Other Error"
