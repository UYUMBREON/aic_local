...
from fastchat.constants import ErrorCode, SERVER_ERROR_MSG, LOG_LEVEL_MODEL_WORKER
...
logger = build_logger("model_worker", f"model_worker_{worker_id}.log", LOG_LEVEL_MODEL_WORKER)
...
def create_model_worker():
    ...
    parser.add_argument(
        "--attn-impl", type=str, default=None
    )
